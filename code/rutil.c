...
/* Select sample of size up to maxSample (without replacement) from list or size
 * populationCount */
/* Store result in array dest.  Array scratch must have space for sampleCount
 * entries. */
/* Returns minimum of populationCount and maxSample */
int sample(random_t *seedp, int *seq, int populationCount, int maxSample,
