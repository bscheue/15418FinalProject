...
typedef enum { ACTIVITY_OVERHEAD, ACTIVITY_STARTUP, ACTIVITY_CREATE_WALKS, ACTIVITY_FIND_STICKING, ACTIVITY_FIND_INTERFERENCE, ACTIVITY_ADD_TO_CLUSTER, ACTIVITY_COUNT } activity_t;
